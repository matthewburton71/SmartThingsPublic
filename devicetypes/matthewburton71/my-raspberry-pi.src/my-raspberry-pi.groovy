...
metadata {
	definition (name: "My Raspberry Pi", namespace: "matthewburton71", author: "Nicholas Wilde/Matthew Burton") {
	...
	tiles {
		valueTile("temperature", "device.temperature", width: 1, height: 1) {
            ...
            backgroundColors:[
                // operating temp: 0-17C  32-158F
                [value: 30, color: "#bc2323"], // red
                [value: 32, color: "#153591"], // dark blue
                [value: 40, color: "#1e9cbb"], // blue green
                [value: 50, color: "#90d2a7"], // pale green
